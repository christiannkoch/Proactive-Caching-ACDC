...
for i in range(0,len(data)):
    ...
    my_plot.legend(["Proxy 1"],ncol = 4, facecolor='white',prop={'size':15},frameon=True)
    fig = my_plot.get_figure()
    fig.autofmt_xdate()
    fig.savefig('figures/Top4/'+data.Run[i]+'.png', bbox_inches='tight')
...
for n in df.Size.unique():
    ...
    figur.savefig('figures/Top4/Heatmaps/'+title+'.png', bbox_inches='tight')
