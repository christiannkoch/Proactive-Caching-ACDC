...
#include <vector>
#ifndef SRC_CACHE_EVICTIONSTRATEGIES_ACDC_PROBATIONARYFIRSTSSAS_H_
#define SRC_CACHE_EVICTIONSTRATEGIES_ACDC_PROBATIONARYFIRSTSSAS_H_

class ProbationaryFirstSSAS : public BasicSSAS{
public:
    ProbationaryFirstSSAS(ARCProbationaryCache* probationaryCache,
...
#endif /* SRC_CACHE_EVICTIONSTRATEGIES_ACDC_PROBATIONARYFIRSTSSAS_H_ */
