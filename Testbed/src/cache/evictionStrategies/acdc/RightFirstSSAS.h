...
#include <vector>
#ifndef SRC_CACHE_EVICTIONSTRATEGIES_ACDC_RIGHTFIRSTSSAS_H_
#define SRC_CACHE_EVICTIONSTRATEGIES_ACDC_RIGHTFIRSTSSAS_H_

class RightFirstSSAS : public BasicSSAS{
public:
    RightFirstSSAS(ARCProbationaryCache* probationaryCache,
...
#endif /* SRC_CACHE_EVICTIONSTRATEGIES_ACDC_RIGHTFIRSTSSAS_H_ */
