...
// 
/* @file ProxyCacheSettings.h
 * @author Johannes Pfannmüller, Christian Koch
 * @date
 * @version 1.0
 *
 * @brief the ProxyCacheSettings struct
 *
 * @section DESCRIPTION
 */
#ifndef SRC_CACHE_PROXYCACHESETTINGST_H_
#define SRC_CACHE_PROXYCACHESETTINGST_H_
#include <string>
#include <vector>
...
#endif /* SRC_CACHE_PROXYCACHESETTINGST_H_ */
